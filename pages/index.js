...
//   return (
//     <div className="text-red-600 flex flex-col items-center justify-center min-h-screen py-2">
//       <Head>
//         <title>Create Next App</title>
//         <link rel="icon" href="/favicon.ico" />
//       </Head>

//       <main className="border-4 font-bold rounded-2xl bg-blue-200 flex flex-col items-center justify-center flex-1 px-20 text-center">
